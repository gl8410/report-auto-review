...
from app.models.analysis import HistoryAnalysisTask, InferredOpinion, AnalysisStatus, OpinionStatus
...
from app.integrations.llm_client import compare_documents_and_extract_opinions
